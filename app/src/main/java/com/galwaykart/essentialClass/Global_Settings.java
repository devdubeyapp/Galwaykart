...
// }
    ...
    public static final int current_soft_version=111;
   ...
   //public static String api_url="http://qa.galwaykart.com/"; //Test
   //public static String web_url="http://qa.galwaykart.com/"; //Test
