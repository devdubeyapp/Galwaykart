 ...
 */
public class MainActivity_old_14_may_2021 extends BaseActivity {
   Spinner spinner1, spinner2, spinner_qty;
    ...
    public void onBackPressed() {
        super.onBackPressed();
            if(!comefrm.equals("")) {
                Intent intent = new Intent(MainActivity_old_14_may_2021.this, ProductListActivity.class);
            ...
            {
                Intent intent = new Intent(MainActivity_old_14_may_2021.this, HomePageActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                CommonFun.finishscreen(this);
            }
...
//        }
        ...
        btn_check_availablity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(st_pincode.equalsIgnoreCase(""))
                    CommonFun.alertError(MainActivity_old_14_may_2021.this,"Please enter valid pincode...");
        ...
        btn_submit_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    CommonFun.alertError(MainActivity_old_14_may_2021.this,"All fields are mandatory to submit review");
                }
                else
...
//        setSupportActionBar(toolbar);
        ...
        dbh=new DatabaseHandler(MainActivity_old_14_may_2021.this);
            ...
            public void onClick(View v) {
                ...
                if(Integer.parseInt(cartqty)>0){
                    ...
                    if(Integer.parseInt(cartqty)>25)
                        CommonFun.alertError(MainActivity_old_14_may_2021.this,"maximum 25 quantity is allowed");
                    else {
...
//
    ...
    private void checkPinCode() {
        ...
        pDialog = new TransparentProgressDialog(MainActivity_old_14_may_2021.this);
...
//                                        btn_check_availablity.setText("Change Location");
                                ...
                                {
                                    Toast.makeText(MainActivity_old_14_may_2021.this,"Something went wrong.\nPlease try again",Toast.LENGTH_LONG).show();
                                    //onBackPressed();
                                }
...
//                    share_body=p_name +"<br/>"+Html.fromHtml(short_desc,0);
    ...
    private void submitReview(String st_comment,String st_nickname){
        ...
        RequestQueue requestQueue=Volley.newRequestQueue(MainActivity_old_14_may_2021.this);
...
//                        }
                        ...
                        CommonFun.showDialog(MainActivity_old_14_may_2021.this,getResult);
                        linear_write_review.setVisibility(View.GONE);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                CommonFun.showVolleyException(error,MainActivity_old_14_may_2021.this);
                        ...
                        if(response!=null){
                            try {
                               ...
                               // CommonFun.alertError(MainActivity.this,st_get_wishList_Status);
                                ...
                                Vibrator vibrator = (Vibrator) MainActivity_old_14_may_2021.this.getSystemService(MainActivity.VIBRATOR_SERVICE);
                                vibrator.vibrate(100);

                                final Dialog dialog = new Dialog(MainActivity_old_14_may_2021.this);
...
//                                    }
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        b = new AlertDialog.Builder(MainActivity_old_14_may_2021.this);
                                        b.setTitle("Alert");
                                        b.setCancelable(false);
                                        ...
                                        b.setPositiveButton("OK", new DialogInterface.OnClickListener()
                                        {
                                            ...
                                            public void onClick(DialogInterface dialog, int whichButton)
                                            {
                                                ...
                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
                                                startActivity(intent);
                                                CommonFun.finishscreen(MainActivity_old_14_may_2021.this);
                                            }
                                        });
                                        b.create().show();
                                    }
...
//        timer.scheduleAtFixedRate(new RemindTask(), 0, seconds * 1000); // delay
    ...
    public class RemindTask extends TimerTask {
        ...
        private void getCartId_v1() {
            ...
            RequestQueue queue = Volley.newRequestQueue(MainActivity_old_14_may_2021.this);
...
////                            editor.commit();
                                ...
                                e.printStackTrace();
                                CommonFun.alertError(MainActivity_old_14_may_2021.this, e.toString());
                            }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            if (error instanceof ServerError) {
                                CommonFun.alertError(MainActivity_old_14_may_2021.this, "Please try to add maximum of 25 qty");
                            } else
                                CommonFun.showVolleyException(error, MainActivity_old_14_may_2021.this);
                                ...
                                if (response != null) {
                                    try {
                                        ...
                                        if(jsonObj.has("qty")) {
                                             ...
                                             */
                                            refreshItemCount(MainActivity_old_14_may_2021.this);
                                            //refreshItemCount();
                                            Vibrator vibrator = (Vibrator) MainActivity_old_14_may_2021.this.getSystemService(MainActivity.VIBRATOR_SERVICE);
                                            vibrator.vibrate(100);
                                        ...
                                        else if(jsonObj.has("message"))
                                        {
                                            ...
                                            CommonFun.alertError(MainActivity_old_14_may_2021.this,st_msg);
...
//                    magento_user_zone.equalsIgnoreCase("rkt")) {
    ...
    private void getProductRating(int startrange,int limitrange){
        ...
        final RequestQueue requestQueue=Volley.newRequestQueue(MainActivity_old_14_may_2021.this);
...
//                        {
    ...
    private void setReviewAdapter() {
        ...
        adapter = new CustomerReviewAdapter(MainActivity_old_14_may_2021.this, itemRatingList);
        progressBar_read_review.setVisibility(View.GONE);
        if (adapter.getItemCount() > 0) {
            ...
            RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(MainActivity_old_14_may_2021.this, spanCount);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if(requestCode==Request_Id_Multiple_Permissions) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                CommonFun.alertError(MainActivity_old_14_may_2021.this, "Must allow Storage permission to Share Product");
            }
        }
    }
