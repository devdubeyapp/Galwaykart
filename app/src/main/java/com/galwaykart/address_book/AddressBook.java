...
public class AddressBook extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent=new Intent(AddressBook.this, CartItemList.class);
...
//                editor.commit();
                ...
                Intent intent = new Intent(AddressBook.this,AddNewAddress.class);
                intent.putExtra("add_new","new");
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);

                startActivity(intent);
                CommonFun.finishscreen(AddressBook.this);
...
//        else
//        {
//            Intent intent=new Intent(AddressBook.this,CustomerAddressBook.class);
//            startActivity(intent);
//            CommonFun.finishscreen(AddressBook.this);
//        }
 ...
 */
                            ...
                            Intent intent=new Intent(AddressBook.this, ExceptionError.class);
                            startActivity(intent);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                       ...
                       // Log.d("ERROR", "error => " + error.toString());
                        ...
                        CommonFun.showVolleyException(error,AddressBook.this);
                        //rel_no_address.setVisibility(View.VISIBLE);
                        //list_address.setVisibility(View.GONE);
                    }
                }
    ...
    private void updateAddressList() {
        ...
        ListAdapter lstadapter = new AddressBookAdapter(AddressBook.this, itemList, R.layout.activity_default_shipping_address_list,
...
//                            pDialog.dismiss();
//
//                    Log.d("user_detail_url_res",response.toString());
//                        try {
...
//
//
//                            //CommonFun.alertError(AddressBook.this,jsonObject_fcode+" "+jsonObject_distid);
//
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                            Intent intent=new Intent(AddressBook.this, ExceptionError.class);
...
//                    pDialog.dismiss();
//
//                CommonFun.alertError(AddressBook.this,error.toString());
//            }
//        });
//
//
...
//
//
//            //CommonFun.alertError(AddressBook.this,"Address same");
