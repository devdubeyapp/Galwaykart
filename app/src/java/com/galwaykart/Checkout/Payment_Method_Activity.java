...
//            bill_region_id = "0";
        ...
        if(st_selected_address.equalsIgnoreCase("Franchisee")) {
            bill_region = pref.getString("bill_region", "");
            bill_street = pref.getString("bill_add_line1", "");
            bill_postcode = pref.getString("bill_postcode", "");
            bill_city = pref.getString("bill_city", "");
            bill_fname = pref.getString("bill_firstname", "");
            bill_lname = pref.getString("bill_lastname", "");
            bill_email = pref.getString("login_email", "");
            st_cust_name = ship_fname + " " + ship_lname;
            bill_telephone = pref.getString("bill_telephone", "");
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    ////Log.d("ewallet_amount",ewallet_amount+"");
                                     //is_ewallet=false;
