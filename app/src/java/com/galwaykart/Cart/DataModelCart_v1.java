...
public class DataModelCart_v1 {
    ...
    public DataModelCart_v1(String arr_cart_qty, String arr_item_name, String arr_item_price, String arr_boolean,String arr_sku,String product_ip,String arr_boolean_edit) {
        this.arr_cart_qty = arr_cart_qty;
        this.arr_item_name = arr_item_name;
        this.arr_item_price = arr_item_price;
        this.arr_boolean = arr_boolean;
