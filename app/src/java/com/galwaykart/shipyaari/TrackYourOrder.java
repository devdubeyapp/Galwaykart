...
/**
 * Created by sumitsaini on 5/25/2018.
 */

public class TrackYourOrder extends BaseActivity {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent=new Intent(TrackYourOrder.this,OrderDetails.class);
...
//                                    tracking_vertical_bar.setProgress(50,true);
                                ...
                                //e.printStackTrace();
                                CommonFun.alertError(TrackYourOrder.this,e.toString());
                            }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //CommonFun.alertError(DeliveryTypeActivity.this,error.toString());
                    CommonFun.showVolleyException(error,TrackYourOrder.this);
                }
            }) {
