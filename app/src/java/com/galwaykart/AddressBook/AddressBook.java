...
//        tokenData = "ituo1gwphqdjidohau02y4dbu6880rof";
    ...
    Button.OnClickListener btn_add_addressOnClickListener
        ...
        public void onClick(View arg0) {
            ...
            Intent intent = new Intent(AddressBook.this,UpdateAddressActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
...
//            super.onPreExecute();
//
////            pDialog = new TransparentProgressDialog(AddressBookClass.this);
////            pDialog.setCancelable(false);
////            pDialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
////            pDialog.show();
//        }
...
//
//
//            //CommonFun.alertError(AddressBookClass.this,"Address same");
