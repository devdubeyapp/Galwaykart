...
/**
 * Created by itsoftware on 27/12/2017.
 */

public class RecyclerViewSortByName  extends RecyclerView.Adapter<RecyclerViewSortByName.ViewHolder>{
    ...
    public RecyclerViewSortByName(Context context, List<DataModel> values) {
...
//        mListener=itemListener;
    ...
    @Override
    public RecyclerViewSortByName.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        view= LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_item, parent, false);

        return new RecyclerViewSortByName.ViewHolder(view);

    }

    @Override
    public void onBindViewHolder(final RecyclerViewSortByName.ViewHolder holder, int position) {

        final DataModel dataModel = mValues.get(position);
        holder.textView_name.setText(dataModel.st_tv_product_name);
        holder.textView_price.setText("Rs: "+dataModel.st_tv_product_price);
